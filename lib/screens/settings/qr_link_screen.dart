...
class QrCodePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawFinderPattern(double x, double y) {
      ...
      canvas.drawRect(
        Rect.fromLTWH(x + pixelSize, y + pixelSize, pixelSize * 5, pixelSize * 5),
    ...
    for (int i = 8; i < 21 - 8; i++) {
      if (i % 2 == 0) {
        canvas.drawRect(Rect.fromLTWH(pixelSize * 6, pixelSize * i, pixelSize, pixelSize), paint);
        canvas.drawRect(Rect.fromLTWH(pixelSize * i, pixelSize * 6, pixelSize, pixelSize), paint);
      }
    }
    ...
    for (int r = 0; r < 21; r++) {
      for (int c = 0; c < 21; c++) {
        if ((r < 8 && c < 8) || (r < 8 && c >= 21 - 8) || (r >= 21 - 8 && c < 8)) {
          continue;
        }
        if (r == 6 || c == 6) {
          continue;
        ...
        if (val < 45) {
          canvas.drawRect(Rect.fromLTWH(c * pixelSize, r * pixelSize, pixelSize, pixelSize), paint);
        }
      }
    }
  }
...
class _QrLinkScreenState extends ConsumerState<QrLinkScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final String userQrData = 'medclock://invite/caregiver?patientId=$userId&meds=$_allowAccess&refills=$_allowRefills';
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      padding: const EdgeInsets.all(20),
                      decoration: BoxDecoration(
                        border: Border.all(color: const Color(0xFFE5EFF2), width: 1.5),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color(0xFF0F6D95).withValues(alpha: 0.15),
                                  blurRadius: 16,
                                  spreadRadius: 4,
